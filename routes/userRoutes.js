...
import { addToPlaylist, changeMyPassword, deleteMyProfile, deleteUser, forgotPassword, getAllUsers, getMyProfile, login, logout, register, removeFromPlaylist, resetPassword, updateMyProfile, updateMyProfilePicture, updateUserRole } from "../controllers/userController.js";
...
router.route("/updateprofilepicture").put(isAuthenticated,singleUpload,updateMyProfilePicture)
